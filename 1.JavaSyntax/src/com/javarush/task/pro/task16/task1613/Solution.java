...
public class Solution {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        boolean isAfterFriday = (dateTime.getDayOfWeek().getValue() == FRIDAY) && dateTime.getHour() >= WEEKEND_START_FRIDAY_CUT_OFF_HOUR;
        boolean isSaturday = dateTime.getDayOfWeek().getValue() == SATURDAY;
        boolean isBeforeSunday = (dateTime.getDayOfWeek().getValue() == SUNDAY) && dateTime.getHour() < WEEKEND_END_SUNDAY_CUT_OFF_HOUR;
        return isAfterFriday || isBeforeSunday || isSaturday;
    }
}
