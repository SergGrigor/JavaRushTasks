...
//            File yourFile = File.createTempFile("your_file_name", null);
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            outputStream.write((staticString + newLine).getBytes());
            outputStream.write((i + newLine).getBytes());
            outputStream.write((j + newLine).getBytes());
        }
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            ClassWithStatic.staticString = strings[0];
            this.i = Integer.parseInt(strings[1]);
            this.j = Integer.parseInt(strings[2]);
        }
